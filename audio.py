...
parser.add_argument('csvfiles', metavar='csv-file', type=str, nargs='*', default='contestants.csv',
                    help='Contestant CSV file(s) to process')
...
for input_csv_filename in args.csvfiles:
    
    contestants = pd.read_csv(input_csv_filename)
